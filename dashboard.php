...
<body>
    ...
    <div class="container">
        ...
        <div class="card mt-2" style="background-color: #fbfbfc !important">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="p-2">
                            <h2>Good evening<br>Thibault Lucas,</h2>
                            <p class="mt-2">Greetings from your customized Dashboard. View information, tools, and practical SMSTextCity solutions that are customised to your account.</p>
                            <a href="sendsms.php" class="btn btn-info btn-rounded btn-sm text-white mt-3">Start Sending SMS</a>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <img src="src/assets/img/sms_home.png" style="max-width: 100%; margin-bottom:-27px !important;" alt="sms home">
                    </div>
                </div>
            </div>
        </div>
