...
<body>
    ...
    if (isset($_POST['loginbtn'])){
        ...
        // $con=Pingsales::conn();
        // $resp=Pingsales::login($em,$pwd);
        // $dec=json_decode($resp,true);
        
        // if ($dec['status']=='success'){
        //   $_SESSION['emm_r']=$dec['emm'];//base64 encode
        //     echo '<div class="alert alert-not-success alert-notify alert-dismissible slideInDown animated"><a href="#" class="close" data-dismiss="alert" aria-label="close"><i class="la la-close bsm"></i></a>Welcome <strong>'.base64_decode($dec['adfullname']).'</strong></div>';
        //     echo '<meta http-equiv="refresh" content="3;dashboard.php">';
        // }
        // else{
        //     //error
        //     echo '<div class="alert alert-not-danger alert-notify alert-dismissible slideInDown animated"><a href="#" class="close" data-dismiss="alert" aria-label="close"><i class="la la-close bsm"></i></a><strong>Login Error:</strong> Invalid logon details</div>';//'.mysqli_error($con).'
        // }

        if (($em=='thibault.lucas@smstextcity.com') && ($pwd=='12345678')){
            $_SESSION['emm_r']=$em;//base64 encode
            echo '<div class="alert alert-not-success alert-notify alert-dismissible slideInDown animated"><a href="#" class="close" data-dismiss="alert" aria-label="close"><i class="la la-close bsm"></i></a>Welcome <strong>'.base64_decode($dec['adfullname']).'</strong></div>';
            echo '<meta http-equiv="refresh" content="3;dashboard.php">';
        }
        else{
